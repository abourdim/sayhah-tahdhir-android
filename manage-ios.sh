#!/usr/bin/env bash
# ============================================================================
#  Sayhah Tahdhir iOS · management console · macOS ONLY
...
SRC_BOOK_DIR="${SRC_BOOK_DIR:-$HOME/Desktop/02_choughl/koutoub/45-sayhah-tahdhir}"
...
cmd_screenshot() {
  ...
  if ! have xcrun; then err "xcrun missing."; pause; return; fi
  local out="/tmp/ios-sayhah-tahdhir-$(date +%Y%m%d-%H%M%S).png"
